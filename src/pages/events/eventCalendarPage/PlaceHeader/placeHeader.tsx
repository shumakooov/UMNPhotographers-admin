...
export default function PlaceHeader({props}: any) {
    ...
    const handleUpdateZoneAndLocation = async () => {
            const response1 = await axios.put(`https://photographersekb.ru:8080/admin/zone/${zoneIdForModal}`, {
                number: Number(zoneNumber),
                description: zone.description,
                manager: zone.manager
            }, {withCredentials: true})

            const response2 = await axios.put(`https://photographersekb.ru:8080/admin/location/${locationIdForModal}`, {
            ...
            <div>
                ...
                >
                    <Box className={styles.modal}>
                        ...
                        <TextField id="outlined-basic" label="Название точки места" variant="outlined"

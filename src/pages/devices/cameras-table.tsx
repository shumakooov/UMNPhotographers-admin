...
const columns: GridColDef[] = [
    ...
    {field: 'cropFactor', headerName: 'Кроп-фактор', width: 150, editable: true},
...
const useFakeMutation = () => {
    return React.useCallback(
        (photographer: Partial<Cameras>) =>
            new Promise<Partial<Cameras>>((resolve, reject) => {
                setTimeout(() => {
...
function computeMutation(newRow: GridRowModel, oldRow: GridRowModel) {
    ...
    if (newRow.cropFactor !== oldRow.cropFactor) {
        return `First name from '${oldRow.cropFactor}' to '${newRow.cropFactor}'`;
    }
